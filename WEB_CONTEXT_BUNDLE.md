...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-mpp-001-p-versus-np-problem-b1f46e30-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/MPP-001"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-mpp-001-p-versus-np-problem-b1f46e30-v1",
      "problem_contract_sha256": "2a16ee286af95cfae83e39b6877bc097da0d35b8f812d607dad9306d25816950",
      "problem_id": "problem:um-mpp-001-p-versus-np-problem-b1f46e30",
      "route_id": "route:um-mpp-001-p-versus-np-problem-b1f46e30-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-mpp-001-p-versus-np-problem-b1f46e30-source-fidelity-01",
      "graph_id": "graph:um-mpp-001-p-versus-np-problem-b1f46e30-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-mpp-001-p-versus-np-problem-b1f46e30-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-mpp-001-p-versus-np-problem-b1f46e30-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does $P = NP$? More formally: if the solution to a problem can be quickly verified (in polynomial time), can the solution also be quickly found (in polynomial time)?"
          },
          "statement_sha256": "d56fade1d1e41fc2fd0c94262a9a3080d46c0c7ccf4278d14d4b4b271343255e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-mpp-001-p-versus-np-problem-b1f46e30-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-mpp-001-p-versus-np-problem-b1f46e30-root",
      "route_id": "route:um-mpp-001-p-versus-np-problem-b1f46e30-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-mpp-001-121ed40a8b34",
        "url": "https://www.unsolvedmath.com/problems/MPP-001"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
